...
(function initContactForm() {
  ...
  form.addEventListener('submit', async (e) => {
    ...
    /* ── BACKEND: Formspree ─────────────────────────────────────────
       Sign up at formspree.io, create a form, and paste your endpoint
       into the <form action="..."> attribute in index.html.
       The fetch below sends to that action URL automatically.
    ─────────────────────────────────────────────────────────────── */
    try {
      ...
      alert('Something went wrong. Please email amaanmohammad088@gmail.com directly.');
      return;
    }
